...
// We create the tile layer that will be the background of our map.
let streetsDark = L.tileLayer('https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token={accessToken}', {
...
let baseMaps = {
  ...
  "Streets Dark Nav": streetsDark
};

// Create the earthquake layer for our map.
let earthquakes = new L.layerGroup();

// Create tectonic plates later
...
// tectonic plate boundary GeoJSON data
